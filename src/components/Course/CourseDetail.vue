                        ...
                        <div class="jq-tab-wrapper" id="horizontalTab">
                            ...
                            <div class="jq-tab-content-wrapper">
                                <div class="jq-tab-content active" data-tab="1">
                                    ...
                                    experts. This is certainly true in astronomy both in terms of terms that refer to
                                    the cosmos and terms that describe the tools of the trade, the most prevalent being
                                    the telescope.
                                    <br>
                                    <br>
                                                ...
                                                <div class="user justify-content-between d-flex">
                                                    ...
                                                    <div class="desc">
                                                        ...
                                                        <p class="comment">
                                                            ...
                                                            Cum ut sed, dolorum asperiores perspiciatis provident, odit
                                                            maxime doloremque aliquam.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
