<template>
    <div>
        ...
        <!--<textarea class="textarea" placeholder="e.g. Hello world" v-model="message"></textarea>-->
        <!--<a class="button" @click="sendMessage">Send Message</a>-->
        <!--</form>-->
        <!--</div>-->
        <!--<div>-->
                        ...
                        <div class="single-popular-carusel">
                            <div class="thumb-wrap relative">
                                ...
                                <div class="meta d-flex justify-content-between">
                                    <p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35
                                    </p>
                                    <h4>$150</h4>
                                </div>
                            </div>
                            <div class="details">
                                ...
                                <p>
                                    When television was young, there was a hugely popular show based on the still
                ...
                <div class="row justify-content-center">
                    <div class="wrap">
                        ...
                        <p>
                            ...
                            telescope. It’s exciting to think about setting up your own viewing station whether that is
                            on the deck.
                        </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 single-blog">
                        ...
                        <p>
                            Plantronics with its GN Netcom wireless headset creates the next generation of wireless
                            headset and other products such as wireless.
                        </p>
                        <a href="#" class="details-btn d-flex justify-content-center align-items-center"><span
                                class="details">Details</span><span class="lnr lnr-arrow-right"></span></a>
                    </div>
                    <div class="col-lg-3 col-md-6 single-blog">
                        ...
                        <p>
                            ...
                            parents to know about. 11% of all adult internet
                        </p>
                        <a href="#" class="details-btn d-flex justify-content-center align-items-center"><span
                                class="details">Details</span><span class="lnr lnr-arrow-right"></span></a>
                    </div>
    ...
    export default {
        ...
        methods: {
            sendMessage() {
                ...
                //     subject: 'FlintsFASDFASFtone',
                //     message: 'FlintAFSDFASstone'
